...
\begin{lstlisting}[caption={Query for q1\_vehicle\_count\_observations}, float=H]
...
\begin{lstlisting}[caption={Query for q2\_situation\_refinement\_over\_graph\_simple}, float=H]
    PREFIX traffic: <http://example.org/traffic#>
    PREFIX xsd: <http://www.w3.org/2001/XMLSchema#>
...
\begin{lstlisting}[caption={Query for q2\_situation\_refinement\_over\_graph\_medium}, float=H]
        PREFIX traffic: <http://example.org/traffic#>
        PREFIX xsd: <http://www.w3.org/2001/XMLSchema#>
...
\begin{lstlisting}[caption={Query for q2\_situation\_refinement\_over\_graph\_complex}, float=H]
    PREFIX traffic: <http://example.org/traffic#>
    PREFIX xsd: <http://www.w3.org/2001/XMLSchema#>
    SELECT ?location ?total
    WHERE {
